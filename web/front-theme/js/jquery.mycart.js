...
(function ($) {
  ...
  var pull_all_product=function () {
    localStorage.products = localStorage.products ? localStorage.products : "";
    var request = $.ajax({
      url: "site/about",
      type: "POST",
      data: {products : localStorage.products},
      dataType: "json"
    });
  ...
  var loadMyCartEvent = function(userOptions){
    ...
    if(!$("#" + idCartModal).length) {
      $('body').append(
        ...
        '<h4 class="modal-title" id="myModalLabel"><span class="glyphicon glyphicon-shopping-cart"></span> Savat</h4>' +
        '</div>' +
        ...
        '<button type="button" onclick="'+pull_all_product()+'" class="btn btn-success" >To\'lovga o\'tish</button>' +
    ...
    var drawTable = function(){
      ...
      $.each(products, function(){
        ...
        $cartTable.append(
          ...
          '<td>' + this.name + '</td>' +
          '<td title="Unit Price">' + this.price + ' sum</td>' +
          '<td title="Quantity"><input type="number" min="1" style="width: 70px;" class="' + classProductQuantity + '" value="' + this.quantity + '"/></td>' +
          '<td title="Total" class="' + classProductTotal + '">' + total + ' sum</td>' +
      ...
      $cartTable.append(products.length ?
        ...
        '<td></td>' +
        '</tr>'
        : '<div class="alert alert-danger" role="alert" id="' + idEmptyCartMessage + '">Savatingiz bo\'sh</div>'
      );
    ...
    var showGrandTotal = function(){
      $("#" + idGrandTotal).text( ProductManager.getTotalPrice()+' sum');
    }
    var showDiscountPrice = function(){
      $("#" + idDiscountPrice).text(options.getDiscountPrice(ProductManager.getAllProducts(), ProductManager.getTotalPrice(), ProductManager.getTotalQuantity()) + ' sum');
    }
