...
$this->params['breadcrumbs'][] = ['label' => 'Nashriyotlar', 'url' => ['index']];
        ...
        <div class="card card-profile">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-3 order-lg-2">
                    <div class="card-profile-image">
                        <a href="#">
                            <img src="/publisher/<?=$model->image?>" class="rounded-circle">
                        </a>
                    </div>
                </div>
            </div>
            <div class="card-header text-center border-0 pt-8 pt-md-4 pb-0 pb-md-4">
                <div class="d-flex justify-content-between">
                   <a href="#" class="btn btn-sm btn-info  mr-4 ">Aktiv</a>
                    <a href="#" class="btn btn-sm btn-default float-right">Nashriyot</a>
                </div>
            </div>
            <div class="card-body pt-0">
                ...
                <div class="text-center">
                    ...
                    <div class="h5 font-weight-300">
                        <i class="ni location_pin mr-2"></i><?=$model->country->name?>, <?=$model->region->name?>
                    </div>
                    <div class="h5 mt-4">
<!--                        <i class="ni business_briefcase-24 mr-2"></i>--><?//=$model->email?><!-- - --><?//=$model->phone?>
    ...
    <div class="col-xl-8 order-xl-1">
        ...
        if(!$query['BookSearch']['publisher_id'])
            $query['BookSearch']['publisher_id']=$model->id;
